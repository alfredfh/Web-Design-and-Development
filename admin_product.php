    ...
    if (mysqli_num_rows($select_product_name) > 0) {
      ...
      if ($insert_product) {
        if ($image_size > 2000000) {
          ...
          if (move_uploaded_file($image_tmp_name, __DIR__ . '/' . $image_folder)) {
...
if(isset($_POST['update_product'])){
  ...
  $update_query = mysqli_query($conn, "UPDATE products SET id='$update_p_id', name='$update_p_name',
  price='$update_p_price', product_detail='$update_p_detail', image='$update_p_img' WHERE id='$update_p_id' ") or die ('query failed');
      ...
      <section class="show-products">
        ...
        <section class="update-container">
          ...
          <form method="post" action="" enctype="multipart/form-data">
            ...
            <input type="reset" value="cancel" class="btn btn-default" id="close-edit">
          </form>
